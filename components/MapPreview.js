...
const MapPreview = props => {
    ...
    if(props.location)
    {
        ...
        // imagePreviewUrl = 'https://maps.google.com/maps?q=university+of+san+francisco&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed';
    }

    return (
        <TouchableOpacity onPress={props.onPress} style={{...styles.mapPreview, ...props.style}}>
            {props.location ? <Image style={styles.mapImage} source={{uri: imagePreviewUrl }}></Image> : props.children}
